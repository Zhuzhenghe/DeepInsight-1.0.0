...
const getFocusModes = (t: any) => [
  {
    key: 'webSearch',
    title: t('focusModes.all'),
    description: t('focusModes.allDescription'),
    icon: <Globe size={20} />,
  },
  {
    key: 'academicSearch',
    title: t('focusModes.academic'),
    description: t('focusModes.academicDescription'),
    icon: <SwatchBook size={20} />,
  },
  {
    key: 'writingAssistant',
    title: t('focusModes.writing'),
    description: t('focusModes.writingDescription'),
    icon: <Pencil size={16} />,
  },
  {
    key: 'wolframAlphaSearch',
    title: t('focusModes.wolframAlpha'),
    description: t('focusModes.wolframAlphaDescription'),
    icon: <BadgePercent size={20} />,
  },
  {
    key: 'youtubeSearch',
    title: t('focusModes.youtube'),
    description: t('focusModes.youtubeDescription'),
    icon: <SiYoutube className="h-5 w-auto mr-0.5" />,
  },
  {
    key: 'redditSearch',
    title: t('focusModes.reddit'),
    description: t('focusModes.redditDescription'),
...
const Focus = ({
  ...
  const focusModes = getFocusModes(t);
    ...
    <Popover className="relative w-full max-w-[15rem] md:max-w-md lg:max-w-lg mt-[6.5px]">
      ...
      >
        {focusMode !== 'webSearch' ? (
          ...
          <div className="flex flex-row items-center space-x-1">
            <ScanEye size={20} />
            <p className="text-xs font-medium hidden lg:block">{t('common.focus')}</p>
          </div>
        )}
      </PopoverButton>
      <Transition
