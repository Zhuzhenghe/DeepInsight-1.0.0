...
const Page = () => {
  ...
  // 根据语言设置页面标题
  useEffect(() => {
    document.title = `${t('settings.title')} - ${t('meta.title')}`;
  }, [t]);
  ...
  const saveConfig = async (key: string, value: any) => {
    ...
    try {
      ...
      const response = await apiPost('/api/config', updatedConfig);
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-black/60 dark:text-white/60 mt-0.5">
                        {t('settings.automaticImageSearchDescription')}
                      </p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-3 bg-light-secondary dark:bg-dark-secondary rounded-lg hover:bg-light-200 dark:hover:bg-dark-200 transition-colors">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-black/60 dark:text-white/60 mt-0.5">
                        {t('settings.automaticVideoSearchDescription')}
                      </p>
                    </div>
                  </div>
                  <Switch
            ...
            {user?.role === 'admin' && (
                ...
                selectedChatModelProvider === 'custom_openai' && (
                  <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex flex-col space-y-1">
                      ...
                      <Input
                        type="text"
                        placeholder={t('settings.customOpenaiApiKeyPlaceholder')}
                    ...
                    <div className="flex flex-col space-y-1">
                      ...
                      <Input
                        type="text"
                        placeholder={t('settings.customOpenaiBaseUrlPlaceholder')}
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <Input
                    type="text"
                    placeholder={t('settings.groqApiKeyPlaceholder')}
